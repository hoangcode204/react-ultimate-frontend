...
onst createBookAPI = (mainText,author,price,quantity,category,thumbnail) => {
...
const updateBookThumbnailAPI = (thumbnail, mainText, author, price, quantity, sold,category) => {
  const URL_BACKEND = "/api/v1/book";
  const data = {
    thumbnail: thumbnail,
    mainText: mainText,
